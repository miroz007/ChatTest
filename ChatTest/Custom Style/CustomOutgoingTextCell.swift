...
class CustomTextCell: MSGMessageCell {
    ...
    override open var message: MSGMessage? {
        didSet {
            ...
            myAvatarView?.image = message.user.avatar
        }
    }
    ...
    override func awakeFromNib() {
        ...
        myAvatarView?.layer.cornerRadius = 20
        ...
        myAvatarView?.addGestureRecognizer(avatarGestureRecognizer)
        myAvatarView?.isUserInteractionEnabled = true
    }
