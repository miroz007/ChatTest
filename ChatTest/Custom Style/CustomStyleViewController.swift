...
class CustomStyleViewController: MSGMessengerViewController {
    ...
    let steve = User(displayName: "Amir", avatar: #imageLiteral(resourceName: "Amir"), avatarUrl: nil, isSender: true)
    
    let tim = User(displayName: "Shemo3", avatar: #imageLiteral(resourceName: "timi"), avatarUrl: nil, isSender: false)
